...
level: User Story
status: Done
status_reason: implementação, validação, revisão e integração aprovadas pelo Navigator em 2026-09-26
updated: 2026-09-26
effort: 7
---
...
- Último checkpoint aprovado desta história: Checkpoint 4, em 2026-09-26.
- Implementação, validação manual, revisão técnica e documentação: concluídas.
- Integração em `master` autorizada e registrada como versão `0.14.0`.
