...
- **Handoff / Próximos Passos**: implementação concluída (persistência, sincronização, seletor, representações Esportivo/Clássico, altura do `Ao vivo`). Backend 191 e frontend 45 testes aprovados. Validação manual aprovada; em revisão (Checkpoint 3).
